...
def save_checkpoint(results, checkpoint_file="deepscale_r_checkpoint.json"):
...
def load_checkpoint(checkpoint_file="deepscale_r_checkpoint.json"):
...
def main():
    ...
    checkpoint_file = "deepscale_r_checkpoint.json"
