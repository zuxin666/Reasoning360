#!/bin/bash
#SBATCH --job-name=zhoujun-dapo-lr2e6cosined2z-bigmath-7k
...
# Math
MATH_DATA_DIR=${WORKING_DIR}/data/bigmath7k_filtered_mar21
bigmath_train_path=${MATH_DATA_DIR}/train.parquet
aime_test_path=${MATH_DATA_DIR}/aime_repeated_8x.parquet
amc_test_path=${MATH_DATA_DIR}/amc_repeated_4x.parquet
...
# test_files="['${codegen_test_path}','${math_test_path}','${aime_test_path}','${amc_test_path}']"
test_files="['${math_test_path}','${aime_test_path}','${amc_test_path}']"
...
"${CONDA_BIN_PATH}python" -m verl.recipe.dapo.src.main_dapo \
    ...
    trainer.resume_from_path=${WORKING_DIR}/checkpoints/Reasoning360/4017-zhoujun-dapo-lr2e6cosined2z-bigmath-7k-Qwen2.5-7B/