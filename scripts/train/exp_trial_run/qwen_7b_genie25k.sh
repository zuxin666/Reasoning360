#!/bin/bash
#SBATCH --job-name=zhoujun-trial-rl-genie25k
...
# Math (train)
deepscaler_train_path=${TRAIN_DATA_DIR}/math__merged_deduped_118.2k.parquet  # TODO
# Math (test)
...
# Code (test)
humaneval_test_path=${TEST_DATA_DIR}/codegen__humaneval_164.parquet  # TODO
...
# Table (test)
multihier_test_path=${TEST_DATA_DIR}/table__multihier_336.parquet  # TODO
hitab_test_path=${TEST_DATA_DIR}/table__hitab_1.6k.parquet  # TODO
# Stem (train)
webinstruct_train_path=${TRAIN_DATA_DIR}/stem__33.0k.parquet # TODO
# Stem (test)
??  # TODO
# ARC-AGI (train)
arc_agi_train_path=${TRAIN_DATA_DIR}/simulation__arcagi1_300.parquet  # TODO
# ARC-AGI (test)
arc_agi_test_path=${TEST_DATA_DIR}/simulation__arcagi1_225.parquet  # TODO
...
# =================== Model ===================
BASE_MODEL=Qwen/Qwen2.5-7B  # TODO
