...
WANDB_EXPERIMENT_NAME="$(hostname)-$(date +%Y%m%d_%H%M%S)-${BASE_MODEL##*/}-single-node-shiboshibo-guru-full"
...
# Code (train)
leetcode_train_path=/lustrefs/users/zhuojun.cheng/Reasoning360/data/train_filtered/codegen__deduped_leetcode2k_2.4k_l1e-5_h0.9_1.3k_reduced_tests.parquet  # TODO: change this
livecodebench_train_path=/lustrefs/users/zhuojun.cheng/Reasoning360/data/train_filtered/codegen__deduped_livecodebench_599_l1e-5_h0.9_451_reduced_tests.parquet  # TODO: change this
primeintellect_train_path=/lustrefs/users/zhuojun.cheng/Reasoning360/data/train_filtered/codegen__deduped_primeintellect_9.6k_l1e-5_h0.9_7.6k_reduced_tests.parquet  # TODO: change this
taco_train_path=/lustrefs/users/zhuojun.cheng/Reasoning360/data/train_filtered/codegen__deduped_taco_11.1k_l1e-5_h0.9_8.9k_reduced_tests.parquet  # TODO: change this
# Code (test)
...
"${CONDA_BIN_PATH}python" -m verl.recipe.dapo.src.main_dapo \
    ...
    actor_rollout_ref.actor.ppo_max_token_len_per_gpu=$((1024*12)) \
    ...
    actor_rollout_ref.ref.log_prob_max_token_len_per_gpu=$((1024*12)) \
    ...
    actor_rollout_ref.rollout.log_prob_max_token_len_per_gpu=$((1024*12)) \
