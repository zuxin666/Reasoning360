...
model_path=/mnt/weka/home/zhuojun.cheng/Reasoning360/checkpoints/Reasoning360/71131-zhoujun-math3k-guru18k-models--Qwen--Qwen2.5-7B-think/global_step_60/actor/huggingface
data_folder=./data/test/
save_folder=./data/test_leaderboard_output/

# Extract model name from the path
model_name=guru-7b-math3k-step60
