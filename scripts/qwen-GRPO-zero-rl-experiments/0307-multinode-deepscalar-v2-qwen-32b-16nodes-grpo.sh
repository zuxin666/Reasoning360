...
#SBATCH --exclusive
#SBATCH --exclude=g42-odin-h100-[068-083,071,216,220]
...
orz_train_path=${DATA_DIR}/deepscaler_preview_zero_style_v2/train.parquet
# math_test_path=${DATA_DIR}/math/test.parquet
aime_test_path=${DATA_DIR}/deepscaler_preview_zero_style_v2/aime.parquet
amc_test_path=${DATA_DIR}/deepscaler_preview_zero_style_v2/amc.parquet
math_test_path=${DATA_DIR}/deepscaler_preview_zero_style_v2/math.parquet
...
WANDB_EXPERIMENT_NAME=deepscaler_preview_zero_style-v2-shibo-math-grpo-16nodes-8196-${BASE_MODEL##*/}
