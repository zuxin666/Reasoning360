...
#SBATCH --exclusive
#SBATCH --exclude=g42-odin-h100-[068-083]
...
orz_train_path=${DATA_DIR}/orz_zero_style/train.parquet
# math_test_path=${DATA_DIR}/math/test.parquet
aime_test_path=${DATA_DIR}/deepscaler_preview_zero_style/aime.parquet
amc_test_path=${DATA_DIR}/deepscaler_preview_zero_style/amc.parquet
math_test_path=${DATA_DIR}/deepscaler_preview_zero_style/math.parquet
...
WANDB_EXPERIMENT_NAME=orz-zero-shibo-math-grpo-16nodes-8196-no-kl-${BASE_MODEL##*/}
