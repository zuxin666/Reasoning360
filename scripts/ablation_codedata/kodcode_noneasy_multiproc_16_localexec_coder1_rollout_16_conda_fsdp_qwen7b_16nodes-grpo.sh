...
codegen_train_path=${DATA_DIR}/codegen-12k-kodcode/train.parquet
kodcode_test_path=${DATA_DIR}/codegen-12k-kodcode/test.parquet
leetcode_taco_test_path=${DATA_DIR}/codegen-12k-leetcode2k-taco/test.parquet

train_files="[${codegen_train_path}]"    
test_files="[${kodcode_test_path},${leetcode_taco_test_path}]"
...
WANDB_EXPERIMENT_NAME=zhoujun-kodcode_noneasy12k-localexec-mp16-rollout16-${BASE_MODEL##*/}-${SLURM_JOB_ID}
