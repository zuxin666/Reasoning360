...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-train-filename', default='simulation__codeio-pyedu',
                        help='Filename prefix for the processed training data.')
    parser.add_argument('--output-test-filename', default='simulation__codeio-pyedu',
    ...
    train_dataset, test_dataset = get_dataset(cache_dir, download=True)
