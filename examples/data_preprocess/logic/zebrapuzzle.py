...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='../data/zebra_puzzles', help='Local directory to save parquet files')
...
User: {{prompt}} Output the grid in the form of a dictionary with keys as header containing a list of the attributes and rows denoting each row of the final grid. Please return the final answer in <answer> </answer> tags, for example <answer> {"header": ["Position", "Nationality", "Job"], "rows": [["1", "british", "plumber"], ["2", "polish", "carpenter"]]} </answer>.
Assistant: <think>
"""
