...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-train-filename', default='codegen__leetcode2k',
                        help='Filename prefix for the processed training data.')
    parser.add_argument('--output-test-filename', default='codegen__leetcode2k',
    ...
    train_dataset, test_dataset = get_dataset(cache_dir)
