...
def code_exec_bwrap(code, stdin: str = None, timeout=5, 
                    pytest: str = None, solution: str = None, 
                    python_env: str = "/usr"):
    env = os.environ.copy()
    ...
    if solution: # not necessarily a pytest file. test solution is just in a separate file that imports solution
        with TemporaryDirectory() as tmpdir:
            ...
            command.extend(["/sandbox/bin/python3", os.path.join(tmpdir, "test_solution.py")])
